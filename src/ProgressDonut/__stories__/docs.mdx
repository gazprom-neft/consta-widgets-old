...
Чтобы показать числа из объекта `data`, добавьте `showText`.
...
Чтобы показать заголовок, добавьте `showTitle`.
...
| [`showTitle?`](#заголвоко)      | `boolean`                          | -            | Показывает заголовок                             |
...
| [`valuePlaceholder?`](#данные-и-цвета) | `string` | -            | Подсказка к числу |
| [`valueMin?`](#данные-и-цвета)         | `number` | -            | Точка отсчета     |
| [`valueMin?`](#данные-и-цвета)         | `number` | -            | План              |
